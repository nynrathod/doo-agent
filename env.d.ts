/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: dc929a174bc584019e993e3e9cbc5c42)
...
interface __BaseEnv_Env {
	...
	API_TOKEN: string;
	EVAL_TOKEN: string;
	DooAgent: DurableObjectNamespace<import("./src/server").DooAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "DooAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCOUNT_ID" | "API_TOKEN" | "EVAL_TOKEN">> {}
}
